          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(Icons.workspace_premium_outlined, color: theme.colorScheme.primary, size: 32),
              ),
              ...
              Icon(Icons.arrow_forward_ios, color: theme.colorScheme.onPrimaryContainer, size: 20),
            ],
          ),
        ),
      ),
    ...
    return Card(
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          child: Icon(Icons.card_giftcard, color: theme.colorScheme.secondary, size: 24),
        ),
        title: Text('Refer a Friend', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w600)),
        subtitle: Text('Get rewards for inviting friends', style: theme.textTheme.bodyMedium),
        trailing: const Icon(Icons.arrow_forward_ios, size: 18),
        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
      ),
    );
