              ...
              child: FutureBuilder<bool>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (hasPro) {
                    ...
                    return _buildProMemberView(context, theme, iapService);
                  }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      ...products
                          .map((product) => _buildProductRow(theme, product)),
                    ],
                  ),
                ),
              );
  ...
  Future<void> _presentIAPManagement(
    ...
    await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
            'You can restore your purchases or manage your subscription through the Play Store app.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.of(context).pop(),
